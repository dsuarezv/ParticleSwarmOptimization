...
namespace Dyqui.PSO
{
    public class Solver
    {
        ...
        public Solver(ErrorFunctionDelegate errFunc, SolverOptions options)
        {
        ...
        public SolverData Initialize()
        {
            var data = new SolverData(mOptions.NumParticles, mOptions.NumDimensions);
        ...
        public async Task<Result> SolveAsync(SolverData data)
        {
            return await Task.Run(() => Solve(data));
        }
        

        public Result Solve(SolverData data)
        {
        ...
        private SolverOptions mOptions;
        private Random mRandom;
    }


    public delegate double ErrorFunctionDelegate(double[] values);
    public delegate void EpochDelegate(Solver sender, SolverData data);
}
